...
<?php //Set widget areas classes based on user choice
    $senior_care_lite_footer_columns = get_theme_mod('senior_care_lite_footer_widget', '4');
    if ($senior_care_lite_footer_columns == '3') {
      $cols = 'col-lg-4 col-md-4';
    } elseif ($senior_care_lite_footer_columns == '4') {
      $cols = 'col-lg-3 col-md-3';
    } elseif ($senior_care_lite_footer_columns == '2') {
