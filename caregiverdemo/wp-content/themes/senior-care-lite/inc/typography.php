...
function senior_care_lite_custom_styles($custom) {
	...
	wp_add_inline_style( 'senior-care-lite-style', $custom );

}
add_action( 'wp_enqueue_scripts', 'senior_care_lite_custom_styles' );

//Sanitizes Fonts
function senior_care_lite_sanitize_fonts( $input ) {
	$valid = array(
		'' => 'Select',
